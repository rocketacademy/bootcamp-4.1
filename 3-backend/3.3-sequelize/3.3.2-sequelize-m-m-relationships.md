...
[Official guide to Sequelize Associations: Many-To-Many relationships](https://sequelize.org/docs/v6/core-concepts/assocs/#many-to-many-relationships)
...
[Official guide to Sequelize Associations: Special methods/mixins added to instances (`belongsToMany`)](https://sequelize.org/docs/v6/core-concepts/assocs/#foobelongstomanybar--through-baz-)
...
[Official Sequelize guide: Advanced M:N Associations](https://sequelize.org/docs/v6/advanced-association-concepts/advanced-many-to-many/)
...
[Official Sequelize guide: Advanced M:N Associations - Super Many-to-Many association](https://sequelize.org/docs/v6/advanced-association-concepts/advanced-many-to-many/#through-tables-versus-normal-tables-and-the-super-many-to-many-association)
