...
<a href="https://www.w3schools.com/cssref/css\_units.asp" target="_blank">W3Schools documents</a> all ways to specify box size.
...
<a href="https://www.w3schools.com/css/css3\_box-sizing.asp" target="_blank">More on `box-sizing` by W3Schools</a>.
...
Position offset properties `top`, `right`, `bottom`, `left` set the relevant offset from the element's position. We can use any <a href="https://www.w3schools.com/cssref/css\_units.asp" target="_blank">CSS unit</a> to express offset.
